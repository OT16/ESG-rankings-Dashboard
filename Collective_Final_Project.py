...
# - - - - - - - - - - - VISUALIZATION - - - - - - - - - - -
  ...
  tab3.markdown(
    """
    ESG Ranking: This metric reflects a company's ESG performance - better sustainability practices.
    PS Ratio (Price-to-Sales Ratio): This ratio compares a company's market 
    capitalization to its total sales revenue - it indicates how much investors
    are willing to pay for each dollar of sales generated by the company.
    PB Ratio (Price-to-Book Ratio): The PB ratio compares a company's market 
    value to its book value - indicating how much investors are willing to 
    pay for each dollar of assets.
    ROA Ratio (Return on Assets Ratio): This ratio measures a company's 
    profitability relative to its total assets - it indicates how 
    efficiently a company is generating profits from its assets.
    Interaction Terms:
    ESG-PS Interaction: The interaction between ESG ranking and PS
    ratio captures how a company's sustainability practices may influence 
